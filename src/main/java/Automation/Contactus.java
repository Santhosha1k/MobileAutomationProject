...
public class Contactus extends Lunchingapplivation {
@Test(priority = 4)
...
driver.findElement(By.xpath("//*[@placeholder='Username']")).sendKeys("Santhosh");
driver.findElement(By.cssSelector("input[placeholder='Email']")).sendKeys("Santhu@gmail.com");
driver.findElement(By.cssSelector("input[type='tel']")).sendKeys("456787");
driver.findElement(By.xpath("//*[@name='message']")).sendKeys("ert tyujhg hgfghn");
