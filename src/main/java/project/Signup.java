...
driver.findElement(By.id("myInput")).sendKeys("Samsung Galaxy Z	");
Thread.sleep(2000);
...
driver.findElement(By.id("inputPassword")).sendKeys("San@123");
driver.findElement(By.id("flexRadioDefault2")).click();
driver.findElement(By.xpath("//*[@placeholder='00000000000']")).sendKeys("6360764387");
driver.findElement(By.id(" address1")).sendKeys("esrdtfyguhuyftdyfugj");
driver.findElement(By.id("address2")).sendKeys("y7ttdrfxgchvjvhgf");
...
driver.findElement(By.id("inputZip")).sendKeys("563128");
driver.findElement(By.xpath("//*[.='Apple']")).click();
driver.findElement(By.cssSelector("input[placeholder='no of mobiles']")).sendKeys("5");
